...
║  status      : Student 🎓                                   ║
║  os          : Linux 🐧  — born to live in a terminal       ║
║  shell       : bash / zsh                                   ║
...
```diff
+ STATUS: DEPLOYED
+ STACK:  Web3 · Solidity · React · Node.js
```
...
- ⛓️ Immutable on-chain ownership records

[![View Repo](https://img.shields.io/badge/%3E__VIEW__REPO-00ff41?style=for-the-badge&logo=github&logoColor=black)](https://github.com/Anubhav-axt)
